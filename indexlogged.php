...
<html lang="en" dir="ltr">
  <head>
    ...
    <section class="header_loggedin" id="header_loggedin">
      ...
      <a href="">Personal</a>&nbsp &nbsp &nbsp &nbsp  </center></br></br>
      ...
      <img src="images\two_lovers.jpg" alt="Profile pic" class="profile_pic" onclick="profile.html'"width="200" height="200"></br></br>
      <center>  <label for="post_self" id="whatsnew">
        <input type="text" name="post_self" value="" placeholder="Whats new today?">
        <button type="button" name="button" id="btn-post">Post</button>
      </label> </center>
    </section>
  </head>
